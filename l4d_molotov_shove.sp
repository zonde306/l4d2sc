...
*	Link	:	http://forums.alliedmods.net/showthread.php?t=187941
...
public Plugin myinfo =
{
	...
	url = "http://forums.alliedmods.net/showthread.php?t=187941"
}
...
public void OnPluginStart()
{
	...
	g_hCvarInfected = CreateConVar(		"l4d_molotov_shove_infected",		"511",			"1=Common, 2=Witch, 4=Smoker, 8=Boomer, 16=Hunter, 32=Spitter, 64=Jockey, 128=Charger, 256=Tank, 511=All.", CVAR_FLAGS );
	...
	CreateConVar(						"l4d_molotov_shove_version",		PLUGIN_VERSION,	"Molotov Shove plugin version.", CVAR_FLAGS|FCVAR_DONTRECORD);
...
bool CheckWeapon(int client)
{
	if( client && IsClientInGame(client) && IsPlayerAlive(client) && GetClientTeam(client) == 2 )
	{
		...
		if( weapon > 0 && IsValidEntity(weapon) )
		{
			...
			if( strcmp(sTemp, "weapon_molotov") == 0 )
				return true;
		}
	}
	return false;
